    ...
    if(isset($_POST['xacnhan'])) {
        ...
        for($i=0;$i<$row_count_donhang['sl_donhang'];$i++){
            if(isset($_POST['check'][$i]) && $_POST['check'][$i] == "true"){
               ...
               $sql_update_donhang=mysqli_query($conn,"update donhang set trangthai='2' where id_donhang='$id_donhang'");
            }
        }
    }
?>
...
<header>
    ...
    <main>
        <h2 style="text-align: center;">Admin Xác Nhận Shop Lấy Hàng</h2><br>
