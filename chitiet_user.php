    ...
    <main>
        ...
        <div class="row w-100">
            <div class="col-3" style="text-align: center;">
                <a href="donhang/xacnhan.php" style="text-decoration: none;color:black;">
                    <img src="img/choxacnhan.jpg" style="width: 200px;height:200px;">
                    <h5>Chờ Xác Nhận</h5>
                </a>
            </div>
            <div class="col-3" style="text-align: center;">
                <a href="donhang/layhang.php" style="text-decoration: none;color:black;">
                    <img src="img/cholayhang.png" style="width: 200px;height:200px;">
                    <h5>Chờ Lấy Hàng</h5>
                </a>
            </div>
            <div class="col-3" style="text-align: center;">
                <a href="donhang/danggiao.php" style="text-decoration: none;color:black;">
                    <img src="img/icon-giao-hang.png" style="width: 200px;height:200px;">
                    <h5>Đang Giao</h5>
                </a>
            </div>
            <div class="col-3" style="text-align: center;">
                <a href="donhang/giaothanhcong.php" style="text-decoration: none;color:black;">
                    <img src="img/giaohangthanhcong.png" style="width: 200px;height:200px;">
                    <h5>Đã Nhận Hàng</h5>
                </a>
            </div>
        </div>
        <hr>
        <a href="?logout=dangxuat" style="text-decoration: none;margin-left:48%;"><b class="btn btn-secondary">Đăng Xuất</b></a>
    </main>
    <footer>
        <div class="row w-100">
            <div class="col-6">
